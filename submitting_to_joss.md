...
- Make sure that the software complies with the [JOSS review criteria](https://joss.readthedocs.io/en/latest/review_criteria.html).
...
If you want to learn more about what the review process looks like in detail, take a look at the [reviewer guidelines](https://joss.readthedocs.io/en/latest/reviewer_guidelines.html).
